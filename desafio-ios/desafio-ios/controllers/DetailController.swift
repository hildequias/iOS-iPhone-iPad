...
class DetailController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    var transitionOperator = Transition()
    ...
    override func viewDidLoad() {
        ...
        titleLabel.font = UIFont(name: ThemeUtils.fontName, size: 21)
        titleLabel.textColor = UIColor.whiteColor()
        titleLabel.text = shot.title
        
        dateLabel.font = UIFont(name: ThemeUtils.fontName, size: 10)
        ...
        viewsCount.font = UIFont(name: ThemeUtils.boldFontName, size: statsCountFontSize)
        viewsCount.textColor = statsCountColor
        viewsCount.text = "\(shot.viewsCount)"
        
        viewsLabel.font = UIFont(name: ThemeUtils.fontName, size: statsLabelFontSize)
        viewsLabel.textColor = statsLabelColor
        viewsLabel.text = "VIEWS"
        
        likesCount.font = UIFont(name: ThemeUtils.boldFontName, size: statsCountFontSize)
        likesCount.textColor = statsCountColor
        likesCount.text = "\(shot.likesCount)"
        
        likesLabel.font = UIFont(name: ThemeUtils.fontName, size: statsLabelFontSize)
        likesLabel.textColor = statsLabelColor
        likesLabel.text = "LIKES"
        
        commentsCount.font = UIFont(name: ThemeUtils.boldFontName, size: statsCountFontSize)
        commentsCount.textColor = statsCountColor
        commentsCount.text = "\(shot.commentCount)"
        
        commentsLabel.font = UIFont(name: ThemeUtils.fontName, size: statsLabelFontSize)
