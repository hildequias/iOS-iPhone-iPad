...
@interface DetalhesCarroViewController : UIViewController <UIAlertViewDelegate, UISplitViewControllerDelegate>{
    
    Carro *carro;
    UIPopoverController *popoverMapa;
    UIPopoverController *popoverSplitVertical;
}
