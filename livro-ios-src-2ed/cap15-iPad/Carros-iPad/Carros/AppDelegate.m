...
- (void)initIpad {
    ...
    UINavigationController *nav2 = [[UINavigationController alloc]
                                     initWithRootViewController:detalhesController];
...
- (void)initIpadEsquerdaDireita_Topico_15_3 {
    // Cria os controllers
    ...
    UISplitViewController *split = [[UISplitViewController alloc] init] ;
    split.viewControllers = [NSArray arrayWithObjects:esquerda,direita, nil];
    // Deixa o UISplitViewController como o controller principal
    self.window.rootViewController = split;
}
